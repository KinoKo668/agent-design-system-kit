...
- 可选的 `hatchkit_insert_input_instance` MCP Tool：对已 Ready Input 的准确 State × Content、Label、Text 与 Supporting text 生成确定性计划，插入真实 Instance；公开 Input 样例仍为 `unbuilt`，因此真实审批和 Figma 登记前保持 Writer 零派发；
